...
options=("*.unique.nonchimeric.fa" "*-PERFECT_reads.fa.unique" "*-PERFECT_reads.fa.unique for Archaeae" "*MAX-MISMATCH-3.unique")
...
select opt in "${options[@]}"; do 
    ...
    3 ) NAME_PAT=${options[1]};                    UDB_NAME=refv6a; echo "You picked option $REPLY"; break;;
    4 ) NAME_PAT=${options[3]};                    UDB_NAME=refv6long; echo "You picked option $REPLY"; break;;
