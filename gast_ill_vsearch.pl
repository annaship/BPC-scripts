...
my $usage = "
   ...
   Illumina ex:
           gast_ill -saveuc -nodup  -in reference_uniques_fasta -db /xraid2-2/g454/blastdbs/gast_distributions/refv4v5.udb -rtax /xraid2-2/g454/blastdbs/gast_distributions/refv4v5.tax -out mydata.gast
   ITS1 ex:         
   (use -ignoregaps)
   gast_ill -ignoregaps -saveuc -nodup  -in my.fasta -db /xraid2-2/g454/blastdbs/gast_distributions/refits1.udb -rtax /xraid2-2/g454/blastdbs/gast_distributions/refits1.tax -out my.gast
 ...
 Options:  
           ...
           -maxr   [Optional] usearch --max_rejects parameter [default: 0]
           -maj    percent majority required for taxonomic consensus [default: 66]
           -nodup  instead of uniquing sequences with mothur just make a copy of existing file with .unique.fa
